...
public class T491 {
    public static void main(String[] args) {
        int[] nums = {4, 6, 7, 7};
//        System.out.println(Arrays.toString(new Solution_T491_self_timeout().findSubsequences(nums).toArray()));
        new Test().test();
    }
}
...
class Test {
    ...
    public void test() {
        ...
        resSet.add(new MyList(new int[]{123}));
        MyList myList = new MyList(new int[]{1, 2, 3});
        System.out.println(resSet.contains(myList));
    }
}
...
查找（广搜、深搜）：2d
Type09_DP：动态规划中的一个重点就是状态转移，而想要做好这个，就得先根据题设找到所有的状态，然后再考虑转移；在做好这块的内容之后，可以考虑简化：如滚动数组
    T63 T343 T96 T70
    【0-1背包】 T416 T1049 T494 T474【一遍过！】 ：（1）有没有-背包；（2）有几个：背包+爬楼梯
    【完全背包】 T518 T70（爬楼梯-完全背包-排列） T377 T322-amount-min T279 T139
    【打家劫舍】 T198 T213 T337
    【买股票】 T121 T122 T123 T188 T309 T714
        ...
        Ⅴ：冷冻期
        Ⅵ：手续费
    【上升子序列】 T300 先用枚举解题，再考虑子问题的重用
                T674 最长连续递增子序列：我们永远知道如何确定一个子序列：index&len即可
                T718 最长重复子数组
                T1143 最长公共子序列：这个题应该被分配到简单里面
                T53 最大子数组和
                T1035 不相交的线
                T392 判断子序列
                T115 不同子序列个数
                T583 两个字符串的删除操作：要学会变通：把问题转化为：最长字串长度
                T72 编辑距离：插入、删除、替换三个操作使得俩字符串相等
                T647 回文子串
                T516 最长回文子串：可以做一定的删除操作